...
# Behavior drivers
#
prps = ['fifo','lru','secondchance']	# which page replacement policies to run
deltas = [1,2,4,8]			# sizes of the reference history window
programs = ['access1','access2']	# which programs to run
...
def genProcess( option_set ):
    ...
    # create the process
    cmdStr = '../userprog/nachos -printstats -prp %(prp)s -delta %(delta)d -x %(program)s' % option_set

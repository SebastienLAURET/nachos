...
#pragma implementation "machine/disk.h"
...
Disk::Disk(char* name, VoidFunctionPtr callWhenDone, size_t callArg)
{
  ...
  if (fileno >= 0)		 	// file exists, check magic number 
    {
      Read(fileno, &magicNum, sizeof(magicNum));

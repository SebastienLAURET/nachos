...
#pragma interface "machine/console.h"
...
extern Semaphore* consoleRead;
extern Semaphore* consoleReadAvail;
extern Semaphore* consoleWrite;
extern Semaphore* consoleWriteDone;
extern int ConsoleWrite(char *buf, int nbytes);
extern int ConsoleRead(char *buf, int nbytes);
class Console {
  public:
